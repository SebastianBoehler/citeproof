...
def test_edge_cases_with_expected_failure_modes_pass() -> None:
    ...
    assert {
        ...
        "supervision-method-conflict",
        "study-design-method-conflict",
        "summarization-style-conflict",
        "agent-setting-conflict",
        "complexity-property-conflict",
        "inference-property-conflict",
        "trainability-property-conflict",
        ...
        "no-overhead-strength-conflict",
        "training-evaluation-role-conflict",
        "evaluation-training-role-conflict",
        "generation-audit-role-conflict",
        "filter-stage-role-conflict",
